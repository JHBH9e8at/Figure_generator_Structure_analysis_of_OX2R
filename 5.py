...
def runexp(flexiroot, sub, out_dir):
    ...
    for obj_name in models:
        cmd.set("cartoon_transparency", 0 , obj_name)
...
#     cmd.set("cartoon_transparency", 0, models[1])

            
#     cmd.set("cartoon_transparency", 0.9, f"{models[1]} and chain B")
#     cmd.set("cartoon_transparency", 0.3, f"{models[1]} and chain C")

#     outfile = out_dir / f"{models[1]}.png"
    #     cmd.ray(1500,1500)
    #     cmd.png(str(outfile))
